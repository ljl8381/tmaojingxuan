...
- (id)init
{
    ...
    if (self) {
        ...
        UINavigationItem *navItem = [[[UINavigationItem alloc] initWithTitle:[SHKRenRen sharerTitle]] autorelease];
        ...
        [backButtonItem addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
        ...
        navItem.leftBarButtonItem = searchBtn;
        [searchBtn release];
